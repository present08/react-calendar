...
export default function Weekdays(props) {
    ...
    for (var weekday = 1; weekday <= 7; weekday += 1) {
        ...
        weekdays.push(_jsx("div", { className: clsx(weekdayClassName, isCurrentDayOfWeek(weekdayDate) && "".concat(weekdayClassName, "--current"), isWeekend(weekdayDate, calendarType) === 'Saturday' ? "".concat(weekdayClassName, "--saturday") || isWeekend(weekdayDate, calendarType) === 'sunday' ? "".concat(weekdayClassName, "--Sunday") ||  ), children: _jsx("abbr", { "aria-label": abbr, title: abbr, children: formatShortWeekday(locale, weekdayDate).replace('.', '') }) }, weekday));
    }
